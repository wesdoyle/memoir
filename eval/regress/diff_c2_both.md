# regress diff: baseline -> c2_both

overrides: `none` -> `{'line_cap': 300, 'line_scale': 20}`

## audit: divergence before -> after (all files · contested)

| directory | HL18 | HL60 | raw |
|---|---|---|---|
| elasticsearch:server/src/main/java/org/elasticsearch/cluster | 20→28/387 · 20→28/270 | 55→60/387 · 55→60/270 | 103→104/387 · 103→104/270 |
...
| opencv:modules/imgproc/src | 4→5/139 · 4→5/87 | 13→21/139 · 13→21/87 | 45→39/139 · 45→39/87 |
| valkey:src | 26→42/738 · 26→42/658 | 66→83/738 · 66→83/658 | 97→102/738 · 97→102/658 |
...
|---|---|---|---|---|
| elasticsearch | 1/100 | 9/100 | Armin Braun ×1, Simon Willnauer ×1, jaymode ×1, Mark Vieira ×1 | Ryan Ernst ×2, Pooya Salehi ×1, Tim Vernum ×1, David Turner ×1 |
...
| valkey | 5/100 | 9/100 | Ping Xie ×2, Harry Lin ×1, zhenwei pi ×1, antirez ×1 | Madelyn Olson ×2, Sarthak Aggarwal ×1, Ricardo Dias ×1, sundb ×1 |
