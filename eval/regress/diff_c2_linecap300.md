# regress diff: baseline -> c2_linecap300

overrides: `none` -> `{'line_cap': 300}`

## audit: divergence before -> after (all files · contested)

| directory | HL18 | HL60 | raw |
|---|---|---|---|
| elasticsearch:server/src/main/java/org/elasticsearch/cluster | 20→20/387 · 20→20/270 | 55→55/387 · 55→55/270 | 103→104/387 · 103→104/270 |
...
| opencv:modules/core/src | 5→4/191 · 3→2/103 | 12→12/191 · 10→10/103 | 38→38/191 · 36→36/103 |
| opencv:modules/imgproc/src | 4→3/139 · 4→3/87 | 13→13/139 · 13→13/87 | 45→41/139 · 45→41/87 |
