# regress: c6_not_mass200

overrides: `{'first_rule': 'not_mass'}` · now 2026-08-21 · seed 42

## audit (last committer outside top-3)

| directory | HL18 all | HL18 contested | HL60 all | HL60 contested | raw all | raw contested |
|---|---|---|---|---|---|---|
| valkey:src | 26/738 (3.5%) | 26/658 (4.0%) | 64/738 (8.7%) | 64/658 (9.7%) | 96/738 (13.0%) | 96/658 (14.6%) |
...
| elasticsearch:server/src/main/java/org/elasticsearch/cluster | 20/387 (5.2%) | 20/270 (7.4%) | 55/387 (14.2%) | 55/270 (20.4%) | 102/387 (26.4%) | 102/270 (37.8%) |
...
| vscode:src/vs/editor/common | 7/229 (3.1%) | 5/171 (2.9%) | 15/229 (6.6%) | 13/171 (7.6%) | 28/229 (12.2%) | 26/171 (15.2%) |
| vscode:src/vs/base/common | 12/158 (7.6%) | 11/105 (10.5%) | 25/158 (15.8%) | 24/105 (22.9%) | 41/158 (25.9%) | 40/105 (38.1%) |
...
| Shay Banon on ES IndexMetadata.java | 35 |
| Shay Banon on ES InternalEngine.java | 33 |
| Shay Banon on ES SearchService.java | 34 |
| Shay Banon on ES Node.java | 42 |
...
| files in the 10 P4 dirs whose creator earns first_authored credit (of 2244) | 1699 |
...
|---|---|---|
| valkey | 100 | None ×16, Daniil Kashapov ×11, Yoav Steinberg ×9, antirez ×8, Björn Svensson ×7 |
| opencv | 100 | Alexander Smorkalov ×12, Vadim Pisarevsky ×10, Giles Payne ×7, Maksim Shabunin ×7, Congxiang Pan ×6 |
...
| vscode | 100 | Matt Bierner ×12, kieferrm ×10, Benjamin Pasero ×7, Rob Lourens ×6, Alexandru Dima ×5 |
