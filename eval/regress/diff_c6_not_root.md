# regress diff: baseline -> c6_not_root

overrides: `none` -> `{'first_rule': 'not_root'}`
...
| valkey:src | 26→26/738 · 26→26/658 | 66→63/738 · 66→63/658 | 97→97/738 · 97→97/658 |
...
| opencv | 0/100 | 0/100 | – | – |
| valkey | 0/100 | 0/100 | – | – |
| vscode | 2/100 | 2/100 | Justin Chen ×1, Kyle Cutler ×1 | kieferrm ×2 |
